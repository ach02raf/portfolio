      ...
      <div className="project-details-contain d-block m-auto">
        ...
        <div className="row">
          {project.imgProject?.[0] && (
            <div className={project.videoProject ? "col-xl-8 col-12" : "col-12"}>
              <Image
        ...
        {project.rapport?.url && (
          <div className="mt-4">
            <Link href={project.rapport.url} className="btn btn-success" download>
              <FontAwesomeIcon icon={faFileAlt} style={{ width: 20 }} className="me-2" />
        ...
        <div className="row justify-content-center mt-4">
          {project.urlSITE?.[0] && (
            <div className="col-md-6">
              <Link href={project.urlSITE[0]} className="project-details-url" target="_blank">
                <p className="text-center">
                  <FontAwesomeIcon className="project-details-link" icon={faLink} />
                  {project.visitSites}
                </p>
              </Link>
            </div>
          ...
          {project.apk && (
            <div className="col-md-6">
              <Link
                ...
                <p className="text-center">
                  <FontAwesomeIcon className="project-details-link" icon={faDownload} />
                  {project.downloadAPK}
                </p>
              </Link>
            </div>
          ...
          {project.urlProject?.[0] && (
            <div className="col-md-6">
              <Link className="project-details-url" href={project.urlProject[0]} target="_blank">
                <p className="text-center">
                  <FontAwesomeIcon className="project-details-link" icon={faCode} />
                  {project.codeSource}
                </p>
              </Link>
            </div>

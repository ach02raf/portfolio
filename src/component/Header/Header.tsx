  ...
  return (
    <div className="sticky-top header">
      ...
      <div className="reseau-social position-fixed">
        <Link target="blanc" href="https://www.linkedin.com/in/ach02raf/">
          <svg
        ...
        <Link target="blanc" href="https://github.com/ach02raf">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="2em"
            viewBox="0 0 496 512">
        ...
        <Link target="blanc" href="https://www.facebook.com/ach02raf">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="2em"
            viewBox="0 0 512 512">
        ...
        <Link
          target="blanc"
          href="https://twitter.com/i/flow/login?redirect_after_login=%2Fach02raf">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="2em"
            viewBox="0 0 512 512">

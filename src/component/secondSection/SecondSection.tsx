      ...
      <div className="col-lg-8 ">
        <div className="secondSection-div m-auto">
          <h2 className="secondSection-div-title">
            ...
            <span className="secondSection-div-title-part-2">{props.secondSection.title[1]}</span>
          </h2>
          <p>
            ...
            <Link href="http://www.isimm.rnu.tn/public/" rel="preload" target="_blank">
              {props.secondSection.description[3]}
            </Link>
            {props.secondSection.description[4]}
            <Link href="https://github.com/ach02raf" rel="preload" target="_blank">
